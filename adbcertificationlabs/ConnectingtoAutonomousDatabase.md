...
The wallet is downloaded from the **Administration** page in the ATP
...
Specify a password of your choice for the wallet. Note that this
...
**Alternatively** use the DB Connection button in the main Database
Details page to download the credentials:

![../Desktop/Screen%20Shot%202019-04-22%20at%2012.23.36%20PM.png](./media/image4.png)

Which opens up a screen where the Wallet can be downloaded as well as
...
Navigate to the location in your system where the file was downloaded
(typically your DOWNLOADS directory). In this example the file will be
called wallet\_ATPXWEEK.zip, the format of the file is always
“wallet\_$dbname.zip”. Extract the contents of the wallet into a
directory (using a zip utility, usually by right clicking on the file),
you will find the following files:

![](./media/image6.png)

There are 4 files you will be working with during the different labs.
...
Start SQL Developer (by clicking the icon on your desktop or selecting
...
Click the **Create Connection** icon in the Connections toolbox on the
...
See below for completed input and test. Notice also that after you save
...
Now that you are connected run test a query. The ATP (or ADW) database
...
working correctly. Copy the SQL below and paste it on the query builder
